&НаКлиенте
Перем мИмяФайла,КаталогВременных, СисИнфо, Версия, ПутьКЛогам, СтруктураУИД,КоличествоПопытокПрочитатьПлан,ИмяВременногоФайлаЗапросов,ЗакрытьПринудительно;                        // имя файла запросов
&НаКлиенте
...
&НаКлиенте
Процедура ААААААААААОчиститьТекстЗапросаОтМусора()
	Элементы.ТекстЗапроса.УстановитьТекст(обПропылесоситьТекстЗапроса(ТекстЗапроса.ПолучитьТекст()));
...
&НаКлиенте
Процедура ОчиститьОтМусора(Команда)
	ТекстЗапроса.УстановитьТекст(обПропылесоситьТекстЗапроса(ТекстЗапроса.ПолучитьТекст()));
КонецПроцедуры
